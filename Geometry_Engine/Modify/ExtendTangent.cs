...
namespace BH.Engine.Geometry
{
    public static partial class Modify
    {
        ...
        public static PolyCurve ExtendTangent(this Arc curve, Point startPoint, Point endPoint)
        {
            List<ICurve> result = new List<ICurve>();
            if(!startPoint.IsOnCurve(curve))
        ...
        public static Circle ExtendTangent(this Circle curve, Point startPoint, Point endPoint)
        {
        ...
        public static Ellipse ExtendTangent(this Ellipse curve, Point startPoint, Point endPoint)
        {
            Reflection.Compute.RecordNote("Can't Extend closed models.");
            return curve;
        }
        ...
        [NotImplemented]
        public static NurbsCurve ExtendTangent(this NurbsCurve curve, Point startPoint, Point endPoint)
        {
            throw new NotImplementedException();
        }
        /***************************************************/

        public static Polyline ExtendTangent(this Polyline curve, Point startPoint, Point endPoint)
        {
            if (curve.IsClosed())
            {
                Reflection.Compute.RecordNote("Can't Extend closed models.");
        ...
        public static PolyCurve ExtendTangent(this PolyCurve curve, Point startPoint, Point endPoint)
        {
            if (curve.IsClosed())
            {
                Reflection.Compute.RecordNote("Can't Extend closed models.");
        ...
        /***************************************************/
        public static ICurve IExtendTangent(this ICurve curve, Point startPoint, Point endPoint)
        {
